...
from acp_cli.commands.run import extract_input_fields, prompt_for_inputs
from acp_cli.main import app
from acp_schema.ir import ResolvedStep, ResolvedWorkflow
...
class TestPromptForInputs:
    ...
    @patch("acp_cli.commands.run.typer.prompt")
    @patch("acp_cli.commands.run.console")
...
"""
        ...
        try:
            with patch("acp_cli.commands.run.asyncio.run") as mock_run:
...
"""
    ...
    @patch("acp_cli.commands.run.asyncio.run")
