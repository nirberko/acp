...
class TestBasicParsing:
    ...
    def test_parse_empty_acp_block(self) -> None:
        """Test parsing an empty acp block."""
        content = 'acp { version = "0.1" project = "test" }'
        result = parse_acp(content)

        assert isinstance(result, ACPFile)
